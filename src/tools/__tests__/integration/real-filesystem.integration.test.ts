...
import { getCodeFiles } from "@/analysis/utils/file-finder.js";
import { analyzeFiles } from "@/analysis/engine/analyzer.js";
import {
  existsSync,
  mkdirSync,
  rmSync,
...
export function getFileName() {
  ...
  describe("Integration with Actual Codebase", () => {
    it("should analyze the actual ink-cli project structure", async () => {
      ...
      expect(packageJson.name).toBe("sage"); // Based on the package.json we saw earlier
