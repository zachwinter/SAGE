 ...
 */
export async function ingestProject(options) {
...
export async function queryGraph(options) {
    ...
    try {
        ...
        try {
            // Execute query
            const result = await client.query(actualDbPath, query, params);
 ...
 */
export async function getDatabaseStatus(projectPath) {
 ...
 */
export function createGitManager(projectPath, debug = false) {
